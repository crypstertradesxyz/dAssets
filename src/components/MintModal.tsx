        ...
        <div className="p-5 space-y-5">
          {currentStep === 'minted' && completedTx ? (
            ...
            <>
                  ...
                  <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center space-x-1">
                    {['10', '50', '100', '500'].map((amt) => (
                      <button
                        ...
                        className="px-2 py-0.5 bg-white/[0.06] hover:bg-white/[0.12] rounded text-[10px] font-mono text-slate-300"
                      >
                        {amt}
                      </button>
                    ))}
              ...
              {/* Stepper Loader */}
              {isMinting && (
                <div className="bg-[#090C10] border border-white/[0.08] rounded-md p-3 space-y-2 text-xs font-mono">
